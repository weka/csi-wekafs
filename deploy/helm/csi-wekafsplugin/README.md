...
![Version: 0.8.5](https://img.shields.io/badge/Version-0.8.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.8.5-SNAPSHOT.67.777aaca](https://img.shields.io/badge/AppVersion-v0.8.5--SNAPSHOT.67.777aaca-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.8.5-SNAPSHOT.67.777aaca"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.5-SNAPSHOT.67.777aaca"` | CSI driver tag |
