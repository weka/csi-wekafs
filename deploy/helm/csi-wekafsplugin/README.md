...
![Version: 2.0.1-SNAPSHOT.12.38b362a](https://img.shields.io/badge/Version-2.0.1--SNAPSHOT.12.38b362a-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.0.1-SNAPSHOT.12.38b362a](https://img.shields.io/badge/AppVersion-v2.0.1--SNAPSHOT.12.38b362a-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.0.1-SNAPSHOT.12.38b362a"` | CSI driver version |
...
| images.csidriverTag | string | `"2.0.1-SNAPSHOT.12.38b362a"` | CSI driver tag |
