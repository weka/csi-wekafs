# CSI WekaFS Driver
![Version: 0.8.5](https://img.shields.io/badge/Version-0.8.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.8.5-SNAPSHOT.46.c373507](https://img.shields.io/badge/AppVersion-v0.8.5--SNAPSHOT.46.c373507-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.8.5-SNAPSHOT.46.c373507"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.5-SNAPSHOT.46.c373507"` | CSI driver tag |
