...
| csiDriverVersion | string | `"2.4.2-SNAPSHOT.34.926d473"` | CSI driver version |
...
| images.csidriverTag | string | `"2.4.2-SNAPSHOT.34.926d473"` | CSI driver tag |
