...
![Version: 0.8.5-SNAPSHOT.69.02d8efd](https://img.shields.io/badge/Version-0.8.5--SNAPSHOT.69.02d8efd-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.8.5-SNAPSHOT.69.02d8efd](https://img.shields.io/badge/AppVersion-v0.8.5--SNAPSHOT.69.02d8efd-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.8.5-SNAPSHOT.69.02d8efd"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.5-SNAPSHOT.69.02d8efd"` | CSI driver tag |
