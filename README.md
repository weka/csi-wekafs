...
![Version: 2.8.0-SNAPSHOT.111.sha.8cbef9e](https://img.shields.io/badge/Version-2.8.0--SNAPSHOT.111.sha.8cbef9e-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.8.0-SNAPSHOT.111.sha.8cbef9e](https://img.shields.io/badge/AppVersion-v2.8.0--SNAPSHOT.111.sha.8cbef9e-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.8.0-SNAPSHOT.111.sha.8cbef9e"` | CSI driver version |
...
| images.csidriverTag | string | `"2.8.0-SNAPSHOT.111.sha.8cbef9e"` | CSI driver tag |
