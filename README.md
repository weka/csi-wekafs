...
![Version: 1.0.0-SNAPSHOT.135.fe54c09](https://img.shields.io/badge/Version-1.0.0--SNAPSHOT.135.fe54c09-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.0.0-SNAPSHOT.135.fe54c09](https://img.shields.io/badge/AppVersion-v1.0.0--SNAPSHOT.135.fe54c09-informational?style=flat-square)
...
| csiDriverVersion | string | `"1.0.0-SNAPSHOT.135.fe54c09"` | CSI driver version |
...
| images.csidriverImage | object | `{"registry":"quay.io","repository":"weka.io/csi-wekafs","tag":"1.0.0-SNAPSHOT.135.fe54c09"}` | CSI driver |
