...
![Version: 2.2.0-SNAPSHOT.22.fef9724](https://img.shields.io/badge/Version-2.2.0--SNAPSHOT.22.fef9724-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.2.0-SNAPSHOT.22.fef9724](https://img.shields.io/badge/AppVersion-v2.2.0--SNAPSHOT.22.fef9724-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.2.0-SNAPSHOT.22.fef9724"` | CSI driver version |
...
| images.csidriverTag | string | `"2.2.0-SNAPSHOT.22.fef9724"` | CSI driver tag |
