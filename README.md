...
![Version: 2.5.1-SNAPSHOT.28.71bc126](https://img.shields.io/badge/Version-2.5.1--SNAPSHOT.28.71bc126-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.5.1-SNAPSHOT.28.71bc126](https://img.shields.io/badge/AppVersion-v2.5.1--SNAPSHOT.28.71bc126-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.5.1-SNAPSHOT.28.71bc126"` | CSI driver version |
...
| images.csidriverTag | string | `"2.5.1-SNAPSHOT.28.71bc126"` | CSI driver tag |
