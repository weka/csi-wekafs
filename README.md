...
![Version: 2.2.1-SNAPSHOT.0.4311004](https://img.shields.io/badge/Version-2.2.1--SNAPSHOT.0.4311004-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.2.1-SNAPSHOT.0.4311004](https://img.shields.io/badge/AppVersion-v2.2.1--SNAPSHOT.0.4311004-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.2.1-SNAPSHOT.0.4311004"` | CSI driver version |
...
| images.csidriverTag | string | `"2.2.1-SNAPSHOT.0.4311004"` | CSI driver tag |
