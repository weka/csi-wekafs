...
![Version: 0.9.0-SNAPSHOT.71.1b331ca](https://img.shields.io/badge/Version-0.9.0--SNAPSHOT.71.1b331ca-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.0-SNAPSHOT.71.1b331ca](https://img.shields.io/badge/AppVersion-v0.9.0--SNAPSHOT.71.1b331ca-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.9.0-SNAPSHOT.71.1b331ca"` | CSI driver version |
...
| images.csidriverTag | string | `"0.9.0-SNAPSHOT.71.1b331ca"` | CSI driver tag |
