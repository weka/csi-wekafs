...
![Version: 2.0.1-SNAPSHOT.15.cfe0c4e](https://img.shields.io/badge/Version-2.0.1--SNAPSHOT.15.cfe0c4e-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.0.1-SNAPSHOT.15.cfe0c4e](https://img.shields.io/badge/AppVersion-v2.0.1--SNAPSHOT.15.cfe0c4e-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.0.1-SNAPSHOT.15.cfe0c4e"` | CSI driver version |
...
| images.csidriverTag | string | `"2.0.1-SNAPSHOT.15.cfe0c4e"` | CSI driver tag |
