...
| csiDriverVersion | string | `"2.4.2-SNAPSHOT.68.74cb32a"` | CSI driver version |
...
| images.csidriverTag | string | `"2.4.2-SNAPSHOT.68.74cb32a"` | CSI driver tag |
