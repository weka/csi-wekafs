...
![Version: 0.9.0-SNAPSHOT.83.e9798d0](https://img.shields.io/badge/Version-0.9.0--SNAPSHOT.83.e9798d0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.0-SNAPSHOT.83.e9798d0](https://img.shields.io/badge/AppVersion-v0.9.0--SNAPSHOT.83.e9798d0-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.9.0-SNAPSHOT.83.e9798d0"` | CSI driver version |
...
| images.csidriverTag | string | `"0.9.0-SNAPSHOT.83.e9798d0"` | CSI driver tag |
