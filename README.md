...
![Version: 2.9.1-SNAPSHOT.1.sha.3008711](https://img.shields.io/badge/Version-2.9.1--SNAPSHOT.1.sha.3008711-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.9.1-SNAPSHOT.1.sha.3008711](https://img.shields.io/badge/AppVersion-v2.9.1--SNAPSHOT.1.sha.3008711-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.9.1-SNAPSHOT.1.sha.3008711"` | CSI driver version |
...
| images.csidriverTag | string | `"2.9.1-SNAPSHOT.1.sha.3008711"` | CSI driver tag |
