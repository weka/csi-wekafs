...
![Version: 2.8.0-SNAPSHOT.85.sha.6112565](https://img.shields.io/badge/Version-2.8.0--SNAPSHOT.85.sha.6112565-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.8.0-SNAPSHOT.85.sha.6112565](https://img.shields.io/badge/AppVersion-v2.8.0--SNAPSHOT.85.sha.6112565-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.8.0-SNAPSHOT.85.sha.6112565"` | CSI driver version |
...
| images.csidriverTag | string | `"2.8.0-SNAPSHOT.85.sha.6112565"` | CSI driver tag |
