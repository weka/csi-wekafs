...
![Version: 2.5.1-SNAPSHOT.63.0197d9f](https://img.shields.io/badge/Version-2.5.1--SNAPSHOT.63.0197d9f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.5.1-SNAPSHOT.63.0197d9f](https://img.shields.io/badge/AppVersion-v2.5.1--SNAPSHOT.63.0197d9f-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.5.1-SNAPSHOT.63.0197d9f"` | CSI driver version |
...
| images.csidriverTag | string | `"2.5.1-SNAPSHOT.63.0197d9f"` | CSI driver tag |
