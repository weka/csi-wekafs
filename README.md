...
![Version: 0.9.0-SNAPSHOT.73.580d68f](https://img.shields.io/badge/Version-0.9.0--SNAPSHOT.73.580d68f-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.0-SNAPSHOT.73.580d68f](https://img.shields.io/badge/AppVersion-v0.9.0--SNAPSHOT.73.580d68f-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.9.0-SNAPSHOT.73.580d68f"` | CSI driver version |
...
| images.csidriverTag | string | `"0.9.0-SNAPSHOT.73.580d68f"` | CSI driver tag |
