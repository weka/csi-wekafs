...
![Version: 2.6.3-SNAPSHOT.26.4220a0b](https://img.shields.io/badge/Version-2.6.3--SNAPSHOT.26.4220a0b-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.6.3-SNAPSHOT.26.4220a0b](https://img.shields.io/badge/AppVersion-v2.6.3--SNAPSHOT.26.4220a0b-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.6.3-SNAPSHOT.26.4220a0b"` | CSI driver version |
...
| images.csidriverTag | string | `"2.6.3-SNAPSHOT.26.4220a0b"` | CSI driver tag |
