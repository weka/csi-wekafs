...
![Version: 2.8.0-SNAPSHOT.4.sha.fb0c2a8](https://img.shields.io/badge/Version-2.8.0--SNAPSHOT.4.sha.fb0c2a8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.8.0-SNAPSHOT.4.sha.fb0c2a8](https://img.shields.io/badge/AppVersion-v2.8.0--SNAPSHOT.4.sha.fb0c2a8-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.8.0-SNAPSHOT.4.sha.fb0c2a8"` | CSI driver version |
...
| images.csidriverTag | string | `"2.8.0-SNAPSHOT.4.sha.fb0c2a8"` | CSI driver tag |
