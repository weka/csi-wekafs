...
| csiDriverVersion | string | `"2.4.2-SNAPSHOT.53.09fd3a2"` | CSI driver version |
...
| images.csidriverTag | string | `"2.4.2-SNAPSHOT.53.09fd3a2"` | CSI driver tag |
