# CSI WekaFS Driver
![Version: 0.8.5](https://img.shields.io/badge/Version-0.8.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.8.5-sergeyvolsnapclonesupport.44.75f99ce](https://img.shields.io/badge/AppVersion-v0.8.5--sergeyvolsnapclonesupport.44.75f99ce-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.8.5-sergeyvolsnapclonesupport.44.75f99ce"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.5-sergeyvolsnapclonesupport.44.75f99ce"` | CSI driver tag |
