...
| csiDriverVersion | string | `"2.3.3-SNAPSHOT.34.f87f87f"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.3-SNAPSHOT.34.f87f87f"` | CSI driver tag |
