...
| csiDriverVersion | string | `"0.8.5-sergeyfixcapacitycalcforexisti.47.057f25f"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.5-sergeyfixcapacitycalcforexisti.47.057f25f"` | CSI driver tag |
