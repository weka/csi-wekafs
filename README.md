...
![Version: 2.6.3-SNAPSHOT.78.67e8c16](https://img.shields.io/badge/Version-2.6.3--SNAPSHOT.78.67e8c16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.6.3-SNAPSHOT.78.67e8c16](https://img.shields.io/badge/AppVersion-v2.6.3--SNAPSHOT.78.67e8c16-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.6.3-SNAPSHOT.78.67e8c16"` | CSI driver version |
...
| images.csidriverTag | string | `"2.6.3-SNAPSHOT.78.67e8c16"` | CSI driver tag |
