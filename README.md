...
| csiDriverVersion | string | `"2.4.2-SNAPSHOT.84.d1d7e03"` | CSI driver version |
...
| images.csidriverTag | string | `"2.4.2-SNAPSHOT.84.d1d7e03"` | CSI driver tag |
