# CSI WekaFS Driver
![Version: 0.8.0-beta2](https://img.shields.io/badge/Version-0.8.0--beta2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.8.0-beta2](https://img.shields.io/badge/AppVersion-v0.8.0--beta2-informational?style=flat-square)
...
| csiDriverVersion | string | `"0.8.0-beta2"` | CSI driver version |
...
| images.csidriverTag | string | `"0.8.0-beta2"` | CSI driver tag |
