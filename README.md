...
![Version: 2.3.1-SNAPSHOT.4.b6b3ae9](https://img.shields.io/badge/Version-2.3.1--SNAPSHOT.4.b6b3ae9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.1-SNAPSHOT.4.b6b3ae9](https://img.shields.io/badge/AppVersion-v2.3.1--SNAPSHOT.4.b6b3ae9-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.3.1-SNAPSHOT.4.b6b3ae9"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.1-SNAPSHOT.4.b6b3ae9"` | CSI driver tag |
