...
# - running the stable wekafs example against a Kubernetes release
# - running the canary wekafs example against a Kubernetes release
# - building the component in the current repo and running the
#   stable wekafs example with that one component replaced against
...
# By default, this script tests sidecars with the CSI wekafs driver,
...
#   "none" disables the deployment of the wekafs driver.
#
...
configvar CSI_PROW_DRIVER_REPO https://github.com/wekaio/csi-wekafs "CSI driver repo"
configvar CSI_PROW_DEPLOYMENT "" "deployment"

# The install_csi_driver function may work also for other CSI drivers,
# as long as they follow the conventions of the CSI wekafs driver.
...
configvar CSI_PROW_SANITY_POD "csi-wekafsplugin-0" "Kubernetes pod with CSI driver"
