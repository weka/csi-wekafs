...
1. Fixes to our prow.sh CI script can be tested in the [CSI hostpath
   repo](https://github.com/wekaio/csi-wekafs) by modifying
   [prow.sh](https://github.com/wekaio/csi-wekafs/blob/master/release-tools/prow.sh)
   along with any overrides in
   [.prow.sh](https://github.com/wekaio/csi-wekafs/blob/master/.prow.sh)
...
1. After all the sidecars have been released, update
   CSI hostpath driver with the new sidecars in the [CSI repo](https://github.com/wekaio/csi-wekafs/tree/master/deploy)
   and [k/k
