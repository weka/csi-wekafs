...
import (
	...
	"github.com/kubernetes-csi/csi-driver-host-path/pkg/wekafs"
)
...
func handle() {
	driver, err := wekafs.NewWekaFsDriver(*driverName, *nodeID, *endpoint, *ephemeral, *maxVolumesPerNode, version)
	if err != nil {
