...
![Version: 2.0.2-SNAPSHOT.25.b170aa4](https://img.shields.io/badge/Version-2.0.2--SNAPSHOT.25.b170aa4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.0.2-SNAPSHOT.25.b170aa4](https://img.shields.io/badge/AppVersion-v2.0.2--SNAPSHOT.25.b170aa4-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.0.2-SNAPSHOT.25.b170aa4"` | CSI driver version |
...
| images.csidriverTag | string | `"2.0.2-SNAPSHOT.25.b170aa4"` | CSI driver tag |
