...
![Version: 2.6.0-SNAPSHOT.56.310e938](https://img.shields.io/badge/Version-2.6.0--SNAPSHOT.56.310e938-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.6.0-SNAPSHOT.56.310e938](https://img.shields.io/badge/AppVersion-v2.6.0--SNAPSHOT.56.310e938-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.6.0-SNAPSHOT.56.310e938"` | CSI driver version |
...
| images.csidriverTag | string | `"2.6.0-SNAPSHOT.56.310e938"` | CSI driver tag |
