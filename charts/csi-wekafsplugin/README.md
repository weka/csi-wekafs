...
![Version: 2.7.6-SNAPSHOT.78.sha.93bd616](https://img.shields.io/badge/Version-2.7.6--SNAPSHOT.78.sha.93bd616-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.7.6-SNAPSHOT.78.sha.93bd616](https://img.shields.io/badge/AppVersion-v2.7.6--SNAPSHOT.78.sha.93bd616-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.7.6-SNAPSHOT.78.sha.93bd616"` | CSI driver version |
...
| images.csidriverTag | string | `"2.7.6-SNAPSHOT.78.sha.93bd616"` | CSI driver tag |
