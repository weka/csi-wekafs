...
![Version: 2.7.1-SNAPSHOT.0.3e4a39d](https://img.shields.io/badge/Version-2.7.1--SNAPSHOT.0.3e4a39d-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.7.1-SNAPSHOT.0.3e4a39d](https://img.shields.io/badge/AppVersion-v2.7.1--SNAPSHOT.0.3e4a39d-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.7.1-SNAPSHOT.0.3e4a39d"` | CSI driver version |
...
| images.csidriverTag | string | `"2.7.1-SNAPSHOT.0.3e4a39d"` | CSI driver tag |
