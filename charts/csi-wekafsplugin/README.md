...
![Version: 2.1.1-SNAPSHOT.14.1cb4ae5](https://img.shields.io/badge/Version-2.1.1--SNAPSHOT.14.1cb4ae5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.1.1-SNAPSHOT.14.1cb4ae5](https://img.shields.io/badge/AppVersion-v2.1.1--SNAPSHOT.14.1cb4ae5-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.1.1-SNAPSHOT.14.1cb4ae5"` | CSI driver version |
...
| images.csidriverTag | string | `"2.1.1-SNAPSHOT.14.1cb4ae5"` | CSI driver tag |
