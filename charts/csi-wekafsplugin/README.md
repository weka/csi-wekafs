...
![Version: 2.1.2-SNAPSHOT.14.18066ae](https://img.shields.io/badge/Version-2.1.2--SNAPSHOT.14.18066ae-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.1.2-SNAPSHOT.14.18066ae](https://img.shields.io/badge/AppVersion-v2.1.2--SNAPSHOT.14.18066ae-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.1.2-SNAPSHOT.14.18066ae"` | CSI driver version |
...
| images.csidriverTag | string | `"2.1.2-SNAPSHOT.14.18066ae"` | CSI driver tag |
