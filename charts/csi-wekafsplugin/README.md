...
| csiDriverVersion | string | `"2.3.1-SNAPSHOT.8.69e3dcd"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.1-SNAPSHOT.8.69e3dcd"` | CSI driver tag |
