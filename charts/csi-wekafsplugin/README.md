...
![Version: 2.3.2-SNAPSHOT.0.2d6f06c](https://img.shields.io/badge/Version-2.3.2--SNAPSHOT.0.2d6f06c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.2-SNAPSHOT.0.2d6f06c](https://img.shields.io/badge/AppVersion-v2.3.2--SNAPSHOT.0.2d6f06c-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.3.2-SNAPSHOT.0.2d6f06c"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.2-SNAPSHOT.0.2d6f06c"` | CSI driver tag |
