...
![Version: 2.7.3-SNAPSHOT.4.cef7d2c](https://img.shields.io/badge/Version-2.7.3--SNAPSHOT.4.cef7d2c-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.7.3-SNAPSHOT.4.cef7d2c](https://img.shields.io/badge/AppVersion-v2.7.3--SNAPSHOT.4.cef7d2c-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.7.3-SNAPSHOT.4.cef7d2c"` | CSI driver version |
...
| images.csidriverTag | string | `"2.7.3-SNAPSHOT.4.cef7d2c"` | CSI driver tag |
