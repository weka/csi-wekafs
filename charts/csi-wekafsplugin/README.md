...
![Version: 2.3.1-SNAPSHOT.0.1ffb3d0](https://img.shields.io/badge/Version-2.3.1--SNAPSHOT.0.1ffb3d0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.1-SNAPSHOT.0.1ffb3d0](https://img.shields.io/badge/AppVersion-v2.3.1--SNAPSHOT.0.1ffb3d0-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.3.1-SNAPSHOT.0.1ffb3d0"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.1-SNAPSHOT.0.1ffb3d0"` | CSI driver tag |
