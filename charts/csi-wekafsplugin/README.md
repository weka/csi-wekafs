...
| csiDriverVersion | string | `"2.1.1-SNAPSHOT.10.374fe1c"` | CSI driver version |
...
| images.csidriverTag | string | `"2.1.1-SNAPSHOT.10.374fe1c"` | CSI driver tag |
