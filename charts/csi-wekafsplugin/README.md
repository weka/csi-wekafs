...
![Version: 2.3.1-SNAPSHOT.2.b3a0ceb](https://img.shields.io/badge/Version-2.3.1--SNAPSHOT.2.b3a0ceb-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.1-SNAPSHOT.2.b3a0ceb](https://img.shields.io/badge/AppVersion-v2.3.1--SNAPSHOT.2.b3a0ceb-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.3.1-SNAPSHOT.2.b3a0ceb"` | CSI driver version |
...
| images.csidriverTag | string | `"2.3.1-SNAPSHOT.2.b3a0ceb"` | CSI driver tag |
