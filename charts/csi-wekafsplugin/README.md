...
![Version: 2.3.3-SNAPSHOT.20.22606ab](https://img.shields.io/badge/Version-2.3.3--SNAPSHOT.20.22606ab-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.3-SNAPSHOT.20.22606ab](https://img.shields.io/badge/AppVersion-v2.3.3--SNAPSHOT.20.22606ab-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.3.3-SNAPSHOT.20.22606ab"` | CSI driver version |
...
| images.registrarsidecar | string | `"registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.9.2"` | CSI registrar sidercar |
...
| images.csidriverTag | string | `"2.3.3-SNAPSHOT.20.22606ab"` | CSI driver tag |
